package de.haw_hamburg.informatik.core.rain_collection_service;
...
public class RainDataController {
    ...
    @RequestMapping("/raindata/insert")
    public ReturnValues insertRainData (@RequestParam(value = "srcid") String srcId, @RequestParam(value = "raining") boolean raining, @RequestParam(value = "intensity") int intensity){
